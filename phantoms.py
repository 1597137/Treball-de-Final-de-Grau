...
def make_all_phantoms(n=256):
    ...
    regions_suaus = make_phantom_suau(n)
    frontera_koch = make_phantom_koch(n)
    ...
    regions_suaus = normalize_to_l2(regions_suaus, target_norm)
    frontera_koch = normalize_to_l2(frontera_koch, target_norm)
    triangular_iterat = normalize_to_l2(triangular_iterat, target_norm)

    return {
        "shepp_logan": shepp_logan,
        "regions_suaus": regions_suaus,
        "frontera_koch": frontera_koch,
